-- ═══════════════════════════════════════════════════════════
-- JEEVIKA ERP v2 — CANONICAL LOCAL SQLITE SCHEMA (V1 MIGRATION)
-- Directory: Database/Local/migrations/
-- Compatible with SQLite 3.24+ and .NET 8 Microsoft.Data.Sqlite
-- All tables, columns, constraints, and financial precision preserved.
-- ═══════════════════════════════════════════════════════════
