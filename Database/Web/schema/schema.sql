-- ═══════════════════════════════════════════════════════════
-- JEEVIKA ERP v2 — CANONICAL WEB POSTGRESQL REFERENCE SCHEMA
-- Location: Database/Web/schema/schema.sql
-- Single source of truth for PostgreSQL tables, columns & constraints.
-- ═══════════════════════════════════════════════════════════
