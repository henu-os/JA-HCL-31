-- ═══════════════════════════════════════════════════════════
-- JEEVIKA ERP v2 — SEED DATA
-- Run this AFTER schema.sql.
-- NOTE: Admin user is auto-created by the backend on first run
-- with BCrypt hashing. This seed file adds only a sample society
-- and financial year for demonstration.
-- ═══════════════════════════════════════════════════════════

SET search_path TO jeevika_erp, public;

-- ── Sample Society ─────────────────────────────────────────
-- (Replace this with your actual society details)
...
-- ── NOTE: Admin user is created by Program.cs on first run.
-- Password will be BCrypt hashed. Default: ADMIN / ADMIN
