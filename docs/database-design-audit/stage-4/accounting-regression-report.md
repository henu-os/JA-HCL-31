...
| :--- | :--- | :--- | :--- |
| **Double-Entry Balance** | `VoucherController.cs`: $\sum \text{Debit} = \sum \text{Credit}$ | **FROZEN (PASS)** | Unchanged. Unbalanced vouchers strictly rejected. |
...
## 2. Regression Invariant Verification Summary
